...
func TestCommandEnvs(t *testing.T) {
	...
	tests := []struct {
		...
		{env: "AGENT_INJECT_VAULT_IMAGE", value: "hashicorp/vault:1.8.0", cmdPtr: &cmd.flagVaultImage},
		...
		{env: "AGENT_INJECT_TEMPLATE_CONFIG_STATIC_SECRET_RENDER_INTERVAL", value: "12s", cmdPtr: &cmd.flagStaticSecretRenderInterval},
	}

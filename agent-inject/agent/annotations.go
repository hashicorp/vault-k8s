...
const (
	...
	// AnnotationAgentGeneratedConfigMapName is the name of the configuration map generated by the
	// Vault Agent Injector. This is only for internal uses and should not be modified by
	// users.
	AnnotationAgentGeneratedConfigMapName = "vault.hashicorp.com/agent-configmap-name"

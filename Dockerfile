...
FROM docker.mirror.hashicorp.services/alpine:3.18.3 as dev
...
FROM docker.mirror.hashicorp.services/alpine:3.18.3 as default
...
FROM registry.access.redhat.com/ubi8/ubi-minimal:8.8-1072 as ubi

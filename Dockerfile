...
FROM docker.mirror.hashicorp.services/alpine:3.24.1 AS dev
...
FROM docker.mirror.hashicorp.services/alpine:3.24.1 AS default
...
FROM registry.access.redhat.com/ubi8/ubi-minimal:8.10-1777392407 AS ubi
